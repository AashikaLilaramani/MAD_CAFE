        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener(){
                public void onItemClick(AdapterView<?> listView,
                    ...
                    if (position == 0) {        		  	// they chose maincourse
                        for (Food f: Food.mainCourse) {      // add all the elements for this array to the arraylist
                            listData.add(f);
                        }
                    }

                    else if (position == 1) {
                        for (Food f: Food.dessert) { 		// they chose dessert
                            listData.add(f);
                        }
                    }

                    else if (position == 2) {
                        for (Food f: Food.drinks) { 		// they chose drinks
                            listData.add(f);
                        }
                    }
            ...
            //getting a reference to ListView in XML
